...
export const OTEL_BOLGELERI: OtelBolgesi[] = [
  {
    ...
    travelTime: { en: '~35–40 min from our Konyaaltı workshop', ru: '~35–40 мин от мастерской в Коньяалты', de: '~35–40 Min von unserer Werkstatt in Konyaaltı' },
    blurb: {
  ...
  },
  {
    ...
    travelTime: { en: '~10–15 min from our Konyaaltı workshop', ru: '~10–15 мин от мастерской в Коньяалты', de: '~10–15 Min von unserer Werkstatt in Konyaaltı' },
    blurb: {
  ...
  },
  {
    ...
    hotels: [
      ...
      'Aydinbey Famous Resort', 'Xanadu Resort (nearby)', 'Belconti Resort (nearby)',
    ],
    travelTime: { en: '~15–20 min from our Konyaaltı workshop', ru: '~15–20 мин от мастерской в Коньяалты', de: '~15–20 Min von unserer Werkstatt in Konyaaltı' },
    blurb: {
  ...
  },
  {
    ...
    travelTime: { en: '~55–65 min from our Konyaaltı workshop', ru: '~55–65 мин от мастерской в Коньяалты', de: '~55–65 Min von unserer Werkstatt in Konyaaltı' },
    blurb: {
