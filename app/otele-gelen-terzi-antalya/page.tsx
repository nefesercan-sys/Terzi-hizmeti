  ...
  return (
    <>
      ...
      <div style={{ background: '#1E3329', color: '#F5F1E8', minHeight: '100vh' }}>
        ...
        <section className="sec" style={{ background: 'rgba(0,0,0,.12)' }} aria-labelledby="keten-h">
          <div className="ctr" style={{ maxWidth: 760, textAlign: 'center' }}>
            <div className="sec-head">
              <span className="eyebrow">🧵 Yeni</span>
              <h2 className="sec-h ff" id="keten-h">Keten & Pamuk Özel Dikim</h2>
              <p className="sec-sub">
                Otelde tatildeyken bu tarz giyinmek mi istiyorsunuz? %100 doğal keten veya pamuktan,
                tam ölçünüze özel diktirin — model örneklerine göz atın, WhatsApp'tan sipariş verin.
              </p>
            </div>
